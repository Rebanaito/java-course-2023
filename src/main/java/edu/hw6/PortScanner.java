...
public class PortScanner {
	...
	private final static Map<Integer, String> ports = Map.<Integer, String>ofEntries(
			...
			Map.entry(22, "TCP/UDP\t\t\tSecure Shell (SSH), secure logins, file transfers (scp, sftp), and port forwarding"),
			...
			Map.entry(143, "TCP/UDP\t\t\tInternet Message Access Protocol (IMAP), management of electronic mail messages on a server"),
			...
			Map.entry(2483, "TCP/UDP\t\t\tOracle database listening for insecure client connections to the listener, replaces port 1521"),
			...
			Map.entry(6665, "TCP\t\t\tInternet Relay Chat (IRC)"),
			Map.entry(6666, "TCP\t\t\tInternet Relay Chat (IRC)"),
			Map.entry(6667, "TCP\t\t\tInternet Relay Chat (IRC)"),
			Map.entry(6668, "TCP\t\t\tInternet Relay Chat (IRC)"),
			Map.entry(6669, "TCP\t\t\tInternet Relay Chat (IRC)"),
			Map.entry(6881, "-\t\t\tBitTorrent is part of the full range of ports used most often"),
			Map.entry(6970, "-\t\t\tQuickTime Streaming Server"),
			Map.entry(6999, "-\t\t\tBitTorrent is part of the full range of ports used most often"),
			...
			Map.entry(10000, "-\t\t\tBackupExec - Webmin, Web-based Unix/Linux system administration tool (default port)"),
